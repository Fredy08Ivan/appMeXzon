        ...
        return (
            ...
            <div className="container">
                ...
                <div className="card" style={{ color: 'red' }}>
                    <img src="img/Slide/2.jpg" className="card-img-top" alt="..." />
                    <div className="text-center">
                        <img src="https://logo-logos.com/wp-content/uploads/2018/02/Apple-Logo-rainbow.png" alt="..." className="image-fluid pres rounded-circle image-thumbnail" width="100px" />
                    </div>
                    <div className="card-body">
                ...
                <div className="card" style={{ color: 'blue' }}>
                    <img src="img/Slide/3.jpg" className="card-img-top" alt="..." />
                    <div className="card-body">
                        <h5 className="card-title">Card title</h5>
